...
struct stivale2_struct_tag_framebuffer {
    ...
    uint16  framebuffer_bpp;
    uint08  memory_model;
    uint08  red_mask_size;
    uint08  red_mask_shift;
    uint08  green_mask_size;
    uint08  green_mask_shift;
    uint08  blue_mask_size;
    uint08  blue_mask_shift;
} __attribute__((__packed__));
