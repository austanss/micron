...
void cpu::tss::tss_install(int num_cpu, address stack) {
    isr_stack = (void *)((address)memory::pmm::request_page() + 0x1000);
    irq_stack = (void *)((address)memory::pmm::request_page() + 0x1000);
    sgi_stack = (void *)((address)memory::pmm::request_page() + 0x1000);
