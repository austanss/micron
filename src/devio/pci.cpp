...
void enumerate_function(address device_address, uint function)
{
    ...
    memory::paging::map_memory((void *)function_address, (void *)function_address, false);
...
void enumerate_device(address bus_address, uint device)
{
    ...
    memory::paging::map_memory((void *)device_address, (void *)device_address, false);
...
void enumerate_bus(address base, uint bus)
{
    ...
    memory::paging::map_memory((void *)bus_address, (void *)bus_address, false);
