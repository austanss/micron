...
int gfx::subif::render_image(subif_file* image, shapes::positional_point pos)
{
	...
	for (uint x = 0; x < image->header->x_res; x++, pos.x++)
		for (uint y = 0; y < image->header->y_res; y++, pos.y++)
...
qword gfx::fonts::get_character_font(char c) { return kernel_font[(int)c]; }