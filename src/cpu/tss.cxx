...
void cpu::tss::tss_install(int num_cpu, address stack) {
    ...
    memory::paging::map_memory((void *)((address)isr_stack - 0x1000), (void *)((address)isr_stack - 0x1000));
    memory::paging::map_memory((void *)((address)irq_stack - 0x1000), (void *)((address)irq_stack - 0x1000));
    memory::paging::map_memory((void *)((address)sgi_stack - 0x1000), (void *)((address)sgi_stack - 0x1000));
