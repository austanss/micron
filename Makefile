...
CC := gcc -I$(HEADERS_DIR) -pipe -ftree-vectorize -D_FILE_OFFSET_BITS=64 -Wall -fno-pic -no-pie -Winvalid-pch -Wnon-virtual-dtor -g -m64 -march=nocona -nostdlib -ffreestanding -O3 -Wall -Wextra -fno-threadsafe-statics -Wl,--build-id=none -Wreturn-type -fpermissive -MD
CXX := g++ -I$(HEADERS_DIR) -pipe -ftree-vectorize -D_FILE_OFFSET_BITS=64 -Wall -fno-pic -no-pie --std=gnu++17 -Winvalid-pch -Wnon-virtual-dtor -g -m64 -march=nocona -nostdlib -ffreestanding -O3 -Wall -Wextra -fno-threadsafe-statics -Wl,--build-id=none -Wreturn-type -fpermissive -MD
ASM := nasm -f elf64
STATIC_LINK := llvm-ar
